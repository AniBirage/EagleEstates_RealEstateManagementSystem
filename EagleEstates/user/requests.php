...
<?php 
    ...
    $requests = $conn->query("SELECT props.id AS id, props.name AS name, props.location AS location, props.image AS image, props.price AS price,
    props.beds AS beds, props.baths AS baths, props.sq_ft AS sq_ft, props.type AS type FROM props JOIN requests ON props.id = requests.prop_id
    ...
    <div class="container">
        ...
        <div class="row mb-5">
         <?php if(count($props) > 0) : ?>
            ...
            <?php endforeach; ?>
         <?php else : ?>
            <div class="alert alert-success bg-success text-white mt-5">You Have Not Sent a Request For Any Property</div>
        <?php endif; ?>   
