          ...
          <div class="card">
            <div class="card-body">
                    ...
                    <form method="POST" action="create-properties.php" enctype="multipart/form-data">
                        ...
                        <div class="form-outline mb-4 mt-4">
                          <input type="text" name="baths" id="form2Example2" class="form-control" placeholder="Baths" />
                        </div>
                        <div class="form-outline mb-4 mt-4">
                            <input type="text" name="sq_ft" id="form2Example1" class="form-control" placeholder="SQ/FT" />
                        </div>   
                        <div class="form-outline mb-4 mt-4">
                            <input type="text" name="year_built" id="form2Example1" class="form-control" placeholder="Year Built" />
                        </div> 
                        <div class="form-outline mb-4 mt-4">
